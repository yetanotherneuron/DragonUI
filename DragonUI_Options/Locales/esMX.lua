...
L["Use Dispel-Type Colors"] = "Usar colores por tipo de disipación"
L["Color debuff borders by Magic, Curse, Poison, Disease, or none. Turn off to use Debuff Border Color instead."] = "Colorea los bordes de perjuicios por Magia, Maldición, Veneno, Enfermedad o ninguno (Blizzard). Desactívalo para usar Color del borde de perjuicios."
