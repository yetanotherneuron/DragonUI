...
L["Show Class Resources"] = true
L["Show DK runes or rogue/druid combo points under the bars."] = true
L["Personal Resource"] = true
L["Enable Player Resource Display under Modules to configure these options."] = true
L["Heal Prediction"] = true
L["Show incoming heal prediction on the personal resource health bar. Requires Unit Frame Layers to be enabled."] = true
L["Test Heal Prediction"] = true
L["Preview heal prediction and absorb overlays for a few seconds on unit frames and the personal resource display."] = true
L["Fake low health with incoming heal and absorb overlays for a few seconds."] = true
L["Size"] = true
L["Health Height"] = true
L["Power Height"] = true
L["Bar Texture"] = true
L["Status bar texture for health and power."] = true
L["Text"] = true
L["Text Size"] = true
L["Class Resources"] = true
L["Class Resource Test"] = true
L["Preview while this panel is open. Closing options uses your real class."] = true
L["Off (use my class)"] = true
L["DK: Mixed Ready"] = true
L["DK: Blood"] = true
L["DK: Unholy"] = true
L["DK: Frost"] = true
L["DK: Death"] = true
L["DK: On Cooldown"] = true
L["Combo: 0"] = true
L["Combo: 1"] = true
L["Combo: 2"] = true
L["Combo: 3"] = true
...
L["Combo Points"] = true
L["Show When"] = true
L["Leave all show conditions off to always display the bars. Enable one or more to limit when they appear."] = true
L["Only show the personal resource display while the mouse is over it."] = true
L["Only show the personal resource display while in combat."] = true
L["Hide the personal resource display while in combat."] = true
L["Show When Health Below"] = true
L["Show when player health is at or below the percent threshold."] = true
L["Health Below %"] = true
L["Show When Power Below"] = true
L["Show when player power (mana/rage/energy/runic) is at or below the percent threshold."] = true
L["Power Below %"] = true
...
L["Debuff borders use Blizzard dispel-type colors by default. Override individual types below."] = true
L["Magic Debuff Color"] = true
L["Curse Debuff Color"] = true
L["Poison Debuff Color"] = true
L["Disease Debuff Color"] = true
L["Physical Debuff Color"] = true
L["Reset Debuff Colors"] = true
L["Clear all debuff color overrides and restore Blizzard dispel-type colors."] = true
L["Border Style"] = true
L["Rounded"] = true
L["Square"] = true
...
-- Buff Tracker
L["Buff Tracker"] = true
L["Shows selected player buff and debuff icons above the Personal Resource Display using action bar-style icon borders."] = true
L["Consumables"] = true
L["Stacks"] = true
L["Enable Buff Tracker"] = true
L["Track configured player buffs above the Personal Resource Display."] = true
L["Require Personal Resource Display"] = true
L["Hide the buff tracker when the Personal Resource Display is disabled."] = true
L["Icon Size"] = true
L["Size of each tracked buff icon."] = true
L["Icon Spacing"] = true
L["Gap between tracked buff icons."] = true
L["Offset Above PRD"] = true
L["Vertical gap between the Personal Resource Display and the buff row."] = true
L["Show Duration"] = true
L["Show remaining time on tracked buff icons."] = true
L["Show Stacks"] = true
L["Show stack count when a tracked aura has more than one application."] = true
L["Border Style"] = true
L["Rounded"] = true
L["Square"] = true
L["Default Border Color"] = true
L["Fallback border color when a watch list entry does not specify one."] = true
L["Red (default)"] = true
L["Utility (blue)"] = true
L["Consumables (orange)"] = true
L["Spells (red)"] = true
...
L["Always while active"] = true
L["Never"] = true
L["Consumable Threshold (sec)"] = true
L["Show consumable icons when remaining time is at or below this value. Default 300 = 5 minutes."] = true
L["Consumable Warning Border"] = true
L["Border color when a consumable is below the threshold. Icon texture stays normal."] = true
L["Expired Consumable Glow"] = true
L["Pulse a small glow when a tracked consumable falls off."] = true
L["Expired Glow Scale"] = true
L["Preview"] = true
L["Preview Buffs"] = true
L["Show sample buff icons above PRD for a few seconds without needing active auras."] = true
L["Stop Buff Preview"] = true
L["Clear the buff tracker preview."] = true
L["Watch Lists"] = true
L["Add spell IDs to track. Icons appear in category order, then by activation order within each category."] = true
L["Weapons"] = true
L["Class"] = true
L["Raid / Party"] = true
L["Item Procs"] = true
L["Active Spells"] = true
L["Category Border Color"] = true
L["Default border color for spells in this watch list."] = true
L["Track Categories"] = true
L["Track Class Actives"] = true
L["Track Class Passives"] = true
L["Track Buffs"] = true
L["Track Procs"] = true
L["Track Consumables"] = true
L["Track Target Stacks"] = true
L["Track Target Debuffs"] = true
-- L["Show your target debuffs (Sunder Armor, diseases, etc.) above the Personal Resource Display. Disable to track them on nameplates only."] = true
L["Track Enchants"] = true
L["Class Actives"] = true
L["Class Passives"] = true
L["Show Tooltip on Hover"] = true
L["Show the spell tooltip when hovering a tracked icon."] = true
