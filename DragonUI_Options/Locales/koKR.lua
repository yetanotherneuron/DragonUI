...
L["Debuff borders use Blizzard dispel-type colors by default. Override individual types below."] = "디버프 테두리는 기본적으로 블리자드 해제 유형 색상을 사용합니다. 아래에서 유형별로 재정의할 수 있습니다."
L["Magic Debuff Color"] = "마법 디버프 색상"
L["Curse Debuff Color"] = "저주 디버프 색상"
L["Poison Debuff Color"] = "독 디버프 색상"
L["Disease Debuff Color"] = "질병 디버프 색상"
L["Physical Debuff Color"] = "물리 디버프 색상"
L["Reset Debuff Colors"] = "디버프 색상 초기화"
L["Clear all debuff color overrides and restore Blizzard dispel-type colors."] = "모든 디버프 색상 재정의를 지우고 블리자드 해제 유형 색상을 복원합니다."
L["Rounded"] = "둥근 모서리"
L["Square"] = "각진 모서리"
