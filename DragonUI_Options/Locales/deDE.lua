...
L["Use Dispel-Type Colors"] = "Bannarten-Farben verwenden"
L["Color debuff borders by Magic, Curse, Poison, Disease, or none. Turn off to use Debuff Border Color instead."] = "Färbt Debuff-Rahmen nach Magie, Fluch, Gift, Krankheit oder ohne Typ (Blizzard). Ausschalten, um stattdessen Debuff-Rahmenfarbe zu nutzen."
