...
L["Debuff borders use Blizzard dispel-type colors by default. Override individual types below."] = "減益邊框預設使用暴雪驅散類型顏色。可在下方個別覆寫。"
L["Magic Debuff Color"] = "魔法減益顏色"
L["Curse Debuff Color"] = "詛咒減益顏色"
L["Poison Debuff Color"] = "中毒減益顏色"
L["Disease Debuff Color"] = "疾病減益顏色"
L["Physical Debuff Color"] = "物理減益顏色"
L["Reset Debuff Colors"] = "重設減益顏色"
L["Clear all debuff color overrides and restore Blizzard dispel-type colors."] = "清除所有減益顏色覆寫並還原暴雪驅散類型顏色。"
L["Rounded"] = "圓角"
L["Square"] = "方形"
