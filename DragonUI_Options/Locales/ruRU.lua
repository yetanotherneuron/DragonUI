...
L["Debuff borders use Blizzard dispel-type colors by default. Override individual types below."] = "По умолчанию рамки дебаффов используют цвета типов диспела Blizzard. Ниже можно переопределить каждый тип."
L["Magic Debuff Color"] = "Цвет магического дебаффа"
L["Curse Debuff Color"] = "Цвет проклятия"
L["Poison Debuff Color"] = "Цвет яда"
L["Disease Debuff Color"] = "Цвет болезни"
L["Physical Debuff Color"] = "Цвет физического дебаффа"
L["Reset Debuff Colors"] = "Сбросить цвета дебаффов"
L["Clear all debuff color overrides and restore Blizzard dispel-type colors."] = "Сбрасывает все переопределения и восстанавливает цвета типов диспела Blizzard."
