        ...
        modules = {
            ...
            bufftracker = {
                ...
                lists = {
                    classes = {
                        actives = {
                            WARRIOR = { spell_ids = "", border_mode = "spells" },
                            PALADIN = { spell_ids = "", border_mode = "spells" },
                            HUNTER = { spell_ids = "", border_mode = "spells" },
                            ROGUE = { spell_ids = "", border_mode = "spells" },
                            PRIEST = { spell_ids = "", border_mode = "spells" },
                            DEATHKNIGHT = { spell_ids = "", border_mode = "spells" },
                            SHAMAN = { spell_ids = "", border_mode = "spells" },
                            MAGE = { spell_ids = "", border_mode = "spells" },
                            WARLOCK = { spell_ids = "", border_mode = "spells" },
                            DRUID = { spell_ids = "", border_mode = "spells" },
                        },
                        passives = {
                            WARRIOR = { spell_ids = "", border_mode = "procs" },
                            PALADIN = { spell_ids = "", border_mode = "procs" },
                            HUNTER = { spell_ids = "", border_mode = "procs" },
                            ROGUE = { spell_ids = "", border_mode = "procs" },
                            PRIEST = { spell_ids = "", border_mode = "procs" },
                            DEATHKNIGHT = { spell_ids = "", border_mode = "procs" },
                            SHAMAN = { spell_ids = "", border_mode = "procs" },
                            MAGE = { spell_ids = "", border_mode = "procs" },
                            WARLOCK = { spell_ids = "", border_mode = "procs" },
                            DRUID = { spell_ids = "", border_mode = "procs" },
                        },
                    },
                    buffs = { spell_ids = "", border_mode = "utility" },
                    procs = { spell_ids = "", border_mode = "procs" },
                    consume = { spell_ids = "", border_mode = "consumables" },
                    stacks = { spell_ids = "", border_mode = "stacks" },
                    enchants = { spell_ids = "", border_mode = "buffs_enchants" },
                },
            },
            itemquality = {
